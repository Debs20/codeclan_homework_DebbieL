...
Q3. Being faced with such complex data can be daunting, we may feel overwhelmed and ask ourselves:
...
Q4. But wait! Some people have given lengthy descriptions of the faces, some have only given one word. This can be problematic for analysis, if you eventually want to summarise key descriptions.
