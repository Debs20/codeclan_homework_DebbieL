...
-- need to work out how to get ordered by last name next as can only get this from z- a
...
SELECT 
  ...
  country
FROM employees
ORDER BY country ASC NULLS LAST, last_name DESC NULLS LAST
...
FROM employees 
WHERE (pension_enrol = TRUE) AND (country != 'French' OR country != 'Germany')
```
